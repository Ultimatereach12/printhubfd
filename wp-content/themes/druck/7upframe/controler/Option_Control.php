 ...
 */
global $s7upf_config;
if(!class_exists('S7upf_OptionConfig'))
{
    class S7upf_OptionConfig
    {
        static $theme;
        ...
        {
            return esc_html__('Theme Option','druck');
        }

        static function _add_themeoptions()
        {
            /* Option is not loaded yet, or this is not an admin request */
        ...
        static function _ot_header_version_text()
        {
            ...
            $title.=' - '. sprintf(esc_html__('Version %s', 'druck'), $ver);
