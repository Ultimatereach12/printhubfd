...
if(!function_exists('s7upf_vc_tabs')){
    function s7upf_vc_tabs($attr, $content = false){
        ...
        $data_array = array_merge(array(
            ...
            'title'         => '',
            'des'           => '',
            'title_tab_style'    => 'title-tab-style1',
            'tab_pos'       => 'top',
            'tab_align'     => 'text-left',
            'tab_ajax'      => 'off',
            'custom_css'    => '',
        ...
        $el_class .= ' '.$style.' '.$title_tab_style;
...
vc_map(
    array(
        'name'          => esc_html__( 'Tabs', 'druck' ),
        'base'          => 's7upf_tabs',
        "category"      => esc_html__("7UP-Elements", 'druck'),
        "description"   => esc_html__( 'Display tabs block', 'druck' ),
        'icon'          => 'icon-st',
        'is_container'  => true,
        ...
        'params'        => array(                       
            ...
            array(
                'type'          => 'dropdown',
                'heading'       => esc_html__( 'Title Tab Style', 'druck' ),
                'param_name'    => 'title_tab_style',
                'value'         => array(
                    esc_html__( 'Default', 'druck' ) => 'title-tab-style1',
                    esc_html__( 'Style 2', 'druck' ) => 'title-tab-style2',
                    esc_html__( 'Style 3', 'druck' ) => 'title-tab-style3',
                    )
            ),
            array(
                'type'          => 'dropdown',
                'heading'       => esc_html__( 'Tab Alignment', 'druck' ),
            ...
            array(
                'type'          => 'dropdown',
                'heading'       => esc_html__( 'Tab Position', 'druck' ),
                'param_name'    => 'tab_pos',
                'value'         => array(
                    esc_html__( 'Top', 'druck' ) => 'top',
                    esc_html__( 'Bottom', 'druck' ) => 'bottom',
                    )
            ),
            array(
                'type'          => 'textfield',
                'heading'       => esc_html__( 'Active section', 'druck' ),
                'param_name'    => 'active_section',
                'description'   => esc_html__( 'Enter active section number. Default is 1.', 'druck' )
            ),
            array(
                'type'          => 'dropdown',
                'heading'       => esc_html__( 'Tab Ajax', 'druck' ),
                'param_name'    => 'tab_ajax',
                'value'         => array(
            ...
            array(
                ...
                'group'         => esc_html__('Design tab content','druck'),
                'description'   => esc_html__( 'Style particular content element differently - add a class name and refer to it in custom CSS.', 'druck' )
                ),
            array(
                "type"          => "css_editor",
        ...
        'default_content' => '
            [vc_tta_section title="' . sprintf( '%s %d', esc_attr__( 'Tab', 'druck' ), 1 ) . '"][/vc_tta_section]
            [vc_tta_section title="' . sprintf( '%s %d', esc_attr__( 'Tab', 'druck' ), 2 ) . '"][/vc_tta_section]
                ',
