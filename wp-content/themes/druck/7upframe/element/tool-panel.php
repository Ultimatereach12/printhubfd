...
if(!function_exists('s7upf_vc_tool_panel'))
{
    function s7upf_vc_tool_panel($attr)
    {
        ...
        $html .=    '<div class="widget-indexdm" id="widget_indexdm">
                        <a href="" class="dm-open dm-button bg-color" data-title="'.esc_attr__("Close","druck").'" data-title-close="'.esc_attr__("Demos","druck").'"><i class="fa fa-long-arrow-left"></i><i class="fa fa-long-arrow-right"></i></a>
                        <a href="'.esc_url($sp_link).'" target="_blank" class="dm-button bg-color dm-support" data-title="'.esc_attr__("Support","druck").'" data-title-close="'.esc_attr__("Support","druck").'"><i class="fa fa-support"></i></a>
                        <a href="'.esc_url($doc_link).'" target="_blank" class="dm-button bg-color dm-guide" data-title="'.esc_attr__("Guide","druck").'" data-title-close="'.esc_attr__("Guide","druck").'"><i class="fa fa-lightbulb-o"></i></a>
                        <div class="widget-indexdm-inner">
                            <div class="dm-header">
                                ...
                                <div class="header-description">
                                    <h2>'.$title.'</h2>
                                    <h4><span class="color2">'.esc_html__("Choose Your Demo","druck").'</span></h4>
                                </div>                                
                                <div class="header-button">
                                    <a target="_blank" class="shop-button1" href="'.esc_url($buy_link).'" title="'.esc_attr__("Buy Now","druck").'">'.esc_html__("Buy Now","druck").'</a>                  
                                </div>
                            </div>';
        if($colors || $colors2){
            // Main color
            ...
            $html .=            '<div class="dm-content-color clearfix">
                                    <h4><span class="color2 text-uppercase title12 font-bold">'.esc_html__("Choose main color","druck").'</span></h4>
            ...
            if(isset($colors[0]) && !empty($colors[0])){
                ...
                $html .=    '<div class="dm-content-color-inner">
                                <a class="dm-color active" href="#" title="'.esc_attr__("Default","druck").'" '.s7upf_add_html_attr('background:'.esc_attr($main_color)).' data-color="'.esc_attr($main_color).'" data-rgb="'.esc_attr($rgb_df).'"></a>';
            ...
            if(isset($colors2[0]) && !empty($colors2[0])){
                ...
                $html .=    '<div class="dm-content-color-inner">
                                <h4><span class="color2 text-uppercase title12 font-bold">'.esc_html__("Choose main color 2","druck").'</span></h4>
                                <a class="dm-color active" href="#" title="'.esc_attr__("Default","druck").'" '.s7upf_add_html_attr('background:'.esc_attr($main_color2)).' data-color2="'.esc_attr($main_color2).'" data-rgb2="'.esc_attr($rgb2_df).'"></a>';
...
vc_map( array(
    "name"      => esc_html__("Tool Panel", 'druck'),
    ...
    "params"    => array(
        ...
        array(
            "type" => "textfield",
            "heading" => esc_html__("Support link",'druck'),
            "param_name" => "sp_link",
        ),
        array(
            "type" => "textfield",
            "heading" => esc_html__("Documentation",'druck'),
            "param_name" => "doc_link",
        ),
        array(
            "type" => "textfield",
            "heading" => esc_html__("Buy Link",'druck'),
            "param_name" => "buy_link",
        ),
        array(
            "type" => "attach_image",
        ...
        array(
            "type" => "param_group",
            "heading" => esc_html__("Demo colors",'druck'),
            "param_name" => "colors",
            "params"    => array(
                array(
                    "type"          => "textfield",
        ...
        array(
            "type" => "param_group",
            "heading" => esc_html__("Demo colors 2",'druck'),
            "param_name" => "colors2",
            "params"    => array(
                array(
                    "type"          => "textfield",
        ...
        array(
            "type" => "param_group",
            "heading" => esc_html__("Demo List",'druck'),
            "param_name" => "demos",
            "params"    => array(
                array(
                    "type"          => "textfield",
                ...
                array(
                    "type" => "attach_image",
                    "heading" => esc_html__("Image item",'druck'),
                    "param_name" => "image_item",
                ),
                array(
                    "type"          => "textfield",
                    "heading"       => esc_html__("Image preview Link",'druck'),
