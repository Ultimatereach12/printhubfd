...
<div class="tabs-block block-element <?php echo esc_attr($el_class)?> tab-ajax-<?php echo esc_attr($tab_ajax)?>">
	...
	<div class="tab-header">
		<ul class="title-tab <?php echo esc_attr($tab_align)?> text-uppercase list-inline-block">
			<?php
			foreach ($tabs as $key => $tab) {
				...
				<li class="<?php echo esc_attr($active)?>">
					<a href="#<?php echo esc_attr($tab['tab_id'])?>" data-target="#<?php echo esc_attr($tab['tab_id']); ?>" data-toggle="tab">
